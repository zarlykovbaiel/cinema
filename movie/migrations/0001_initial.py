# Generated by Django 3.2.8 on 2021-10-07 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2021, verbose_name='Дата выпуска')),
                ...
                ('actors', models.ManyToManyField(related_name='film_actors', to='movie.Human', verbose_name='Актёр')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movie.category', verbose_name='Категориия')),
                ('directors', models.ManyToManyField(related_name='film_director', to='movie.Human', verbose_name='Режиссёр')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.movie', verbose_name='Фильмы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('images', models.ImageField(upload_to='movieshots/', verbose_name='Изображение')),
